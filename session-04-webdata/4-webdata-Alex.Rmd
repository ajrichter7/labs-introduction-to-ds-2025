...
```{r}
str_view(example.obj, "\\d\\.")
str_view(example.obj, "[0-9]\\.")
str_view(example.obj, "[A-Za-z]\\.")
```
:::
...
```{r}
# Your code here
str_view(stringr::words, "[a-df-z]ed$")
```
:::
...
```{r}
# Your code here
stringr::str_detect(stringr::words, "^[A-Za-z][A-Za-z]y$") |> sum()
