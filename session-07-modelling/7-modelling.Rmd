...
formula_string3 <- paste("life_expectancy", "~ gdp + population + alcohol")
formula3 <- as.formula(formula_string3)
reg3 <- lm(formula3, data = life_expec_dat)
summary(reg3)

formula_string4 <- paste("life_expectancy", "~ gdp + population + alcohol + gdp*population")
formula4 <- as.formula(formula_string4)
reg4 <- lm(formula4, data = life_expec_dat)
summary(reg4)

formula_string5 <- paste("life_expectancy", "~ gdp + I(gdp^2) + I(log(population))")
formula5 <- as.formula(formula_string5)
reg5 <- lm(formula5, data = life_expec_dat)
summary(reg5)
...
#View the object visuall first from the global environment 
#Look into stargazer package{https://www.rdocumentation.org/packages/stargazer/versions/5.2.3/topics/stargazer}
for(i in 1:31){
